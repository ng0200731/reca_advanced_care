...
export default function LabelCanvas({
  ...
  const canvas = useMemo(() => {
    ...
    const effectiveMaxDisplayPx = maxDisplayPx * zoom;

    const scale = Math.min(effectiveMaxDisplayPx / w, effectiveMaxDisplayPx / h, 12);
    const cw = w * scale;
    const ch = h * scale;
  ...
  }, [widthMm, heightMm, orientation, maxDisplayPx, zoom, showFold, foldOrientation, foldDistanceMm, foldMidForm]);
